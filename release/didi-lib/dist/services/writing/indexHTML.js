...
var generate_html_index_1 = require("../../glue/generate-html-index");
var path_1 = require("path");
var writeFile = fs_1.promises.writeFile;
exports.indexHTML = function (_a, _b) {
    var options = _a.options;
    var importMap = _b.importMap, constants = _b.constants;
    return __awaiter(void 0, void 0, void 0, function () {
        var htmlIndexContent, e_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 3, , 4]);
                    return [4, generate_html_index_1.generateHtmlIndex({
                            lang: 'en',
                            title: 'didi roars!',
                ...
                case 1:
                    htmlIndexContent = _c.sent();
                    return [4, writeFile(path_1.resolve(constants.MODULE_OUT_ROOT, 'index.html'), htmlIndexContent, 'utf8')];
                case 2:
                    _c.sent();
                    return [3, 4];
                case 3:
