...
var cjs_to_esm_transformer_1 = require("@wessberg/cjs-to-esm-transformer");
var fs_1 = require("fs");
var readFile = fs_1.promises.readFile;
exports.tscESM = function (path, target) { return __awaiter(void 0, void 0, void 0, function () {
    var tscResult, content;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, readFile(path, 'utf8')];
            case 1:
                content = _a.sent();
                try {
                ...
                if (tscResult.outputText) {
                    return [2, tscResult.outputText];
                }
                else {
                    return [2, "throw new Error('didi failed to parse this file.') " + content];
                }
                return [2];
        }
    });
