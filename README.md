...
`client-didi-cli` points to the `packages/lib-demo-project` for development, this allows tsc and node to compile and run on any changed packaged. The example project is detailed by the `Try it out` section.
